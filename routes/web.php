...
use App\Http\Controllers\PharmacyTreatmentPlanController;
use App\Http\Controllers\PharmacyTreatmentPlanCycleController;
...
Route::middleware(['auth', 'verified', 'ensure.active.branch'])->group(function (): void {
    ...
    Route::get('pharmacy/prescriptions/{prescription}/treatment-plans/create', [PharmacyTreatmentPlanController::class, 'create'])->name('pharmacy.treatment-plans.create');
    Route::post('pharmacy/prescriptions/{prescription}/treatment-plans', [PharmacyTreatmentPlanController::class, 'store'])->name('pharmacy.treatment-plans.store');
    ...
    Route::get('pharmacy/treatment-plans', [PharmacyTreatmentPlanController::class, 'index'])->name('pharmacy.treatment-plans.index');
    Route::get('pharmacy/treatment-plans/{treatmentPlan}', [PharmacyTreatmentPlanController::class, 'show'])->name('pharmacy.treatment-plans.show');
    Route::get('pharmacy/treatment-plans/{treatmentPlan}/cycles/{cycle}/dispense', [PharmacyTreatmentPlanCycleController::class, 'create'])->name('pharmacy.treatment-plans.cycles.create');
    Route::post('pharmacy/treatment-plans/{treatmentPlan}/cycles/{cycle}/dispense', [PharmacyTreatmentPlanCycleController::class, 'store'])->name('pharmacy.treatment-plans.cycles.store');
