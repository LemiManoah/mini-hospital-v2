            ...
            [
                ...
                'fields' => [
                    ...
                    [
                        ...
                        'description' => 'Example: PAT',
                        'type' => 'text',
                        'default' => 'PAT',
                    ],
                    [
                        'field' => 'visit_number_prefix',
                        'key' => 'numbering.visit_number_prefix',
                        'label' => 'Visit number prefix',
                        'description' => 'Example: VIS',
                        'type' => 'text',
                        'default' => 'VIS',
                    ],
                    [
                        ...
                        'description' => 'Example: RCPT',
                        'type' => 'text',
                        'default' => 'RCPT',
                    ],
                    [
                        'field' => 'lab_request_prefix',
                        'key' => 'numbering.lab_request_prefix',
                        'label' => 'Lab request prefix',
