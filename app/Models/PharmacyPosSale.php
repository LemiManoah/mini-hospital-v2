 ...
 * @property-read \Illuminate\Database\Eloquent\Collection<int, PharmacyPosSaleItem> $items
 * @property-read \Illuminate\Database\Eloquent\Collection<int, PharmacyPosPayment> $payments
 */
