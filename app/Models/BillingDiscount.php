 ...
 * @property-read BillingDiscountStatus|null $status
 ...
 */
final class BillingDiscount extends Model
{
    use BelongsToTenant;
    use HasUuids;
    use SoftDeletes;
    ...
    protected $casts = [
        ...
        'amount' => 'decimal:2',
        'status' => BillingDiscountStatus::class,
        'requested_by' => 'string',
    ...
    {
        return $query->where('status', BillingDiscountStatus::APPROVED->value);
    }
}
