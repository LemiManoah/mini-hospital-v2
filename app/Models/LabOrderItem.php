 ...
 * @property-read string $lab_order_id
 * @property-read string $test_id
 * @property-read LabOrderItemStatus $status
 ...
 */
final class LabOrderItem extends Model
{
    use HasUuids;
    ...
    /** @return HasMany<LabOrderItemConsumable, $this> */
    public function consumables(): HasMany
    {
        return $this->hasMany(LabOrderItemConsumable::class, 'lab_order_item_id');
    }

    /** @return HasOne<LabResultEntry, $this> */
    public function resultEntry(): HasOne
    {
        return $this->hasOne(LabResultEntry::class, 'lab_order_item_id');
    }

    /** @return HasOne<LabSpecimen, $this> */
    public function specimen(): HasOne
    {
        return $this->hasOne(LabSpecimen::class, 'lab_order_item_id');
    }
    ...
    protected function workflowStage(): Attribute
    {
        return Attribute::get(function (): string {
            if ($this->status === LabOrderItemStatus::CANCELLED) {
                return 'cancelled';
            }
    ...
    protected function resultVisible(): Attribute
    {
        return Attribute::get(
            fn (): bool => $this->approved_at !== null && $this->status === LabOrderItemStatus::COMPLETED,
        );
    }
}
