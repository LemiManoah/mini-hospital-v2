...
final readonly class CreatePatientRegistrationDTO
{
    ...
    public static function fromRequest(FormRequest $request): self
    {
        ...
        return new self(
            ...
            clinicId: self::nullableString($validated['clinic_id'] ?? null),
            doctorId: self::nullableString($validated['doctor_id'] ?? null),
            isEmergency: $validated['is_emergency'] ?? false,
            billingType: $validated['billing_type'],
            insuranceCompanyId: self::nullableString($validated['insurance_company_id'] ?? null),
            insurancePackageId: self::nullableString($validated['insurance_package_id'] ?? null),
        );
    }
