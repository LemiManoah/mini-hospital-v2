...
final readonly class StaffPositionController implements HasMiddleware
{
    public static function middleware(): array
    {
        return [
            new Middleware('permission:staff_positions.view', only: ['index']),
            new Middleware('permission:staff_positions.create', only: ['create', 'store']),
            new Middleware('permission:staff_positions.update', only: ['edit', 'update']),
            new Middleware('permission:staff_positions.delete', only: ['destroy']),
        ];
    }
