    ...
    public function masterData(Request $request): Response
    {
        return $this->renderSection(
            ...
            [
                ...
                [
                    'title' => 'Charge Master',
                    'description' => 'Maintain current billable item prices used by billing and insurance resolution.',
                    'href' => '/charge-masters',
                    'permission' => 'charge_masters.view',
                ],
                [
                    'title' => 'Facility Services',
                    'description' => 'Manage chargeable services, consultation services, pricing, and service availability.',
