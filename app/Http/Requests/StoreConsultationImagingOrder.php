...
final class StoreConsultationImagingOrder extends FormRequest
{
    ...
    public function createDto(): CreateImagingOrderDTO
    {
        return CreateImagingOrderDTO::fromRequest($this);
    }
