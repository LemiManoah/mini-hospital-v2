...
final class StoreLabOrderItemConsumableRequest extends FormRequest
{
    ...
    public function dto(): CreateLabOrderItemConsumableDTO
    {
        return CreateLabOrderItemConsumableDTO::fromRequest($this);
    }
