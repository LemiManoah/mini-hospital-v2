...
import { type AppointmentCategoryFormPageProps } from '@/types/appointment';
...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
        title: 'Create Appointment Category',
        href: '/appointment-categories/create',
    },
];

export default function AppointmentCategoryCreate({
    clinics,
}: AppointmentCategoryFormPageProps) {
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                            Group appointments by service line or clinic stream.
                        </p>
                    </div>
