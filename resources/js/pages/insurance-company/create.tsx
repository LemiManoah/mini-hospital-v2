        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="m-2 overflow-hidden rounded border border-zinc-200 bg-white shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
                <Form
                    ...
                    method="post"
                    onSuccess={() => toast.success('Insurance company created successfully.')}
                        ...
                        <div className="max-w-2xl space-y-6">
                            ...
                            <div className="grid gap-4">
                                <div className="grid gap-2">
                                    ...
                                    <Input id="name" name="name" placeholder="e.g. Jubilee Insurance" autoFocus required />
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="grid gap-2">
                                        ...
                                        <Input id="email" name="email" type="email" placeholder="e.g. claims@company.com" />
                                    ...
                                    <div className="grid gap-2">
                                        ...
                                        <Input id="main_contact" name="main_contact" placeholder="e.g. +256700000000" />
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="grid gap-2">
                                        ...
                                        <Input id="other_contact" name="other_contact" />
