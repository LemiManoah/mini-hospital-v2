...
import { type PharmacyQueuePageProps } from '@/types/pharmacy';
                ...
                <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                    <div className="space-y-2">
                        ...
                        <p className="max-w-3xl text-sm text-muted-foreground">
                            Review pending prescriptions, spot likely stock
                            issues early, and open a patient’s medication order
                            before creating a dispense record.
                        </p>
                        <div className="flex flex-wrap gap-2 text-xs text-muted-foreground">
                            ...
                            <span>
                                Queue items: {prescriptions.total}
                            </span>
                        </div>
                    </div>
