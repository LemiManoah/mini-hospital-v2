...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Create Referral Facility', href: '/referral-facilities/create' },
];

export default function ReferralFacilityCreate() {
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Create Referral Facility" />

            <div className="m-4 max-w-4xl space-y-6">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-2xl font-semibold">
                            Create Referral Facility
                        </h1>
                        <p className="text-sm text-muted-foreground">
                            Add a referral destination for consultation
                            outcomes.
                        </p>
                    </div>
