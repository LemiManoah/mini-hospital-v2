                    ...
                    <div className="space-y-6">
                                ...
                                <CardContent className="space-y-4">
                                    ...
                                    <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="font-medium">
                                                {triage.news_score ?? 'N/A'} /{' '}
                                                {triage.pews_score ?? 'N/A'}
                                            </p>
                                        </div>
                                        <div>
                                            <p className="text-sm text-muted-foreground">
                                            ...
                                            <p className="font-medium">
                                                {[
                                                    triage.requires_priority
                                                        ? 'Priority'
                                                        : null,
                                                    triage.is_pediatric
                                                        ? 'Pediatric'
                                                        : null,
                                                    triage.poisoning_case
                                                        ? 'Poisoning'
                                                        : null,
                                                    triage.snake_bite_case
                                                        ? 'Snake bite'
                                                        : null,
                                                ]
                                                    .filter(Boolean)
                            ...
                            <CardContent className="space-y-6">
                                {!triage ? (
                                    <div className="rounded-lg border border-dashed px-4 py-6 text-sm text-muted-foreground">
                                        Record triage first to unlock vital
                                        signs for this visit.
                                    </div>
                                ) : (
                                    <>
                                        {latestVital ? (
                                            ...
                                            <p className="text-sm text-muted-foreground">
                                                No vitals recorded yet for this
                                                visit.
                                            </p>
                                        )}
                                                ...
                                                <div className="space-y-4 rounded-lg border p-4">
                                                    ...
                                                    <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                                                        <div className="grid gap-2">
                                                            ...
                                                            <InputError
                                                                message={
                                                                    errors.oxygen_delivery_method
                                                                }
                                                            />
                                                        </div>
                                                        <div className="grid gap-2">
                                                            <Label htmlFor="oxygen_flow_rate">
                                                                Oxygen Flow Rate
                                                            </Label>
                                                            <Input
                                                                id="oxygen_flow_rate"
                                                            ...
                                                            <InputError
                                                                message={
                                                                    errors.oxygen_flow_rate
                                                                }
                                                            />
                                                        </div>
                                                        <div className="grid gap-2">
                                                            <Label htmlFor="blood_glucose">
                                                                Blood Glucose
                                                            </Label>
                                                            <Input
                                                                id="blood_glucose"
                                                    ...
                                                    <div className="grid gap-4 md:grid-cols-2">
                                                        <div className="grid gap-2">
                                                            ...
                                                            <InputError
                                                                message={
                                                                    errors.chest_circumference_cm
                                                                }
                                                            />
                                                        </div>
                                                        <div className="grid gap-2">
                                                            <Label htmlFor="capillary_refill">
                                                                Capillary Refill
                                                            </Label>
                                                            <Input
                                                                id="capillary_refill"
                                                          ...
                                                          <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
                                                              <div>
                                                                  ...
                                                                  <p className="text-sm text-muted-foreground">
                                                                      ...
                                                                      by{' '}
                                                                      {vital.recordedBy
                                                                          ? `${vital.recordedBy.first_name} ${vital.recordedBy.last_name}`
                                                                          : 'Unknown staff'}
                                                                  </p>
                                                              </div>
                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-6">
                                {!triage ? (
                                    <div className="rounded-lg border border-dashed px-4 py-6 text-sm text-muted-foreground">
                                        Record triage first to unlock the doctor
                                        consultation workspace for this visit.
                                    </div>
                                ) : (
                                    <div className="space-y-4 rounded-lg border p-4">
                                        <p className="text-sm text-muted-foreground">
                                            Consultation has been moved into the
                                            dedicated Doctors workspace so the
                                            visit page can stay focused on
                                            registration, triage, vitals, and
                                            visit status.
                                        </p>
                                        <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
                                            <div>
                                        ...
                                        <div className="flex justify-end">
                                            <Button asChild>
                                                ...
                                                >
                                                    <NotebookPen className="mr-2 h-4 w-4" />
                                                    {consultation
                                                        ? 'Continue in Consultation Workspace'
                                                        : 'Start in Consultation Workspace'}
                                                </Link>
                                            </Button>
                                        </div>
                                    </div>
                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-3 text-sm">
                                {triage ? (
                                    ...
                                    <p className="text-muted-foreground">
                                        Triage has not been recorded yet. Saving
                                        triage will automatically move the visit
                                        into progress.
                                    </p>
                                )}
                            </CardContent>
                            ...
                            <CardContent className="space-y-3 text-sm">
                                {consultation ? (
                                    ...
                                    <p className="text-muted-foreground">
                                        ...
                                        Use the dedicated Doctors workspace to
                                        start the note and manage downstream
                                        clinical work.
                                    </p>
                                )}
                            </CardContent>
                        ...
                        <Card>
                            ...
                            <CardContent className="space-y-2 text-sm text-muted-foreground">
                                <div className="rounded-md border px-3 py-2">
                                    ...
                                    Orders, procedures, and service requests
                                </div>
                                <div className="rounded-md border px-3 py-2">
