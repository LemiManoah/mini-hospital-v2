                ...
                {solutionCards.map((card) => (
                    ...
                    >
                        <div className="mb-14 flex items-start justify-between">
                            ...
                            <card.icon className="h-8 w-8 text-stone-400 transition-colors group-hover:text-[#4A6FA5] dark:text-stone-600 dark:group-hover:text-[#7ea2d6]" />
                        </div>
                        <h3 className="font-[Manrope] text-2xl font-bold tracking-[-0.05em] text-stone-950 uppercase dark:text-stone-100">
                            {card.title}
                        </h3>
                        <p className="mt-4 max-w-md text-sm leading-7 text-stone-600 dark:text-stone-400">
                            {card.description}
                        </p>
                        <div className="mt-10 inline-flex items-center gap-2 border-b border-[#4A6FA5]/25 pb-1 font-[Manrope] text-[10px] font-bold tracking-[0.3em] text-[#4A6FA5] uppercase transition-all group-hover:border-[#4A6FA5] dark:text-[#7ea2d6] dark:group-hover:border-[#7ea2d6]">
                            {card.cta}
                        </div>
                    </div>
                ))}
