    ...
    public function down(): void
    {
        ...
        Schema::table('lab_order_items', function (Blueprint $table): void {
            foreach ([
                ...
                if (Schema::hasColumn('lab_order_items', $foreignColumn)) {
            ...
            foreach ([
                ...
                if (Schema::hasColumn('lab_order_items', $column)) {
