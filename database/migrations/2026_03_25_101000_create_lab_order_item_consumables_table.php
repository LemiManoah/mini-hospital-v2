...
return new class extends Migration
{
    ...
    {
        if (! Schema::hasTable('lab_order_item_consumables')) {
            Schema::create('lab_order_item_consumables', function (Blueprint $table): void {
                ...
                $table->index(['lab_order_item_id', 'used_at']);
            });
        }
    }
    ...
    {
        Schema::dropIfExists('lab_order_item_consumables');
    }
};
