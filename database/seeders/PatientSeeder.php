...
final class PatientSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $insurancePackage = $insuranceCompany
            ? InsurancePackage::query()
        ...
        $patients = [
            [
                ...
                'phone_number'            => '+256-700-100-001',
                'email'                   => 'amara.nakigozi@example.com',
                'marital_status'          => MaritalStatus::MARRIED,
                'occupation'              => 'Teacher',
                'religion'                => Religion::CHRISTIAN,
                'blood_group'             => BloodGroup::A_POSITIVE,
                'next_of_kin_name'        => 'Samuel Nakigozi',
                'next_of_kin_phone'       => '+256-700-200-001',
                'next_of_kin_relationship'=> KinRelationship::SPOUSE,
                'default_payer_type'      => PayerType::CASH,
                'insured'                 => false,
            ],
            [
                ...
                'gender'                  => Gender::MALE,
                'phone_number'            => '+256-700-100-002',
                'email'                   => null,
                'marital_status'          => MaritalStatus::SINGLE,
                'occupation'              => 'Engineer',
                'religion'                => Religion::CHRISTIAN,
                'blood_group'             => BloodGroup::O_POSITIVE,
                'next_of_kin_name'        => 'Rose Ochieng',
                'next_of_kin_phone'       => '+256-700-200-002',
                'next_of_kin_relationship'=> KinRelationship::SIBLING,
                'default_payer_type'      => PayerType::INSURANCE,
                'insured'                 => true,
            ],
            [
                ...
                'gender'                  => Gender::FEMALE,
                'phone_number'            => '+256-700-100-003',
                'email'                   => 'fatuma.namusisi@example.com',
                'marital_status'          => MaritalStatus::MARRIED,
                'occupation'              => 'Businesswoman',
                'religion'                => Religion::MUSLIM,
                'blood_group'             => BloodGroup::B_POSITIVE,
                'next_of_kin_name'        => 'Hassan Namusisi',
                'next_of_kin_phone'       => '+256-700-200-003',
                'next_of_kin_relationship'=> KinRelationship::SPOUSE,
                'default_payer_type'      => PayerType::CASH,
                'insured'                 => false,
            ],
            [
                ...
                'gender'                  => Gender::MALE,
                'phone_number'            => '+256-700-100-004',
                'email'                   => null,
                'marital_status'          => MaritalStatus::WIDOWED,
                'occupation'              => 'Retired',
                'religion'                => Religion::CHRISTIAN,
                'blood_group'             => BloodGroup::AB_POSITIVE,
                'next_of_kin_name'        => 'David Ssekandi',
                'next_of_kin_phone'       => '+256-700-200-004',
            ...
            [
                ...
                'gender'                  => Gender::FEMALE,
                'phone_number'            => '+256-700-100-005',
                'email'                   => 'diana.akello@example.com',
                'marital_status'          => MaritalStatus::SINGLE,
                'occupation'              => 'Student',
                'religion'               => Religion::CHRISTIAN,
                'blood_group'             => BloodGroup::O_NEGATIVE,
                'next_of_kin_name'        => 'Margaret Akello',
                'next_of_kin_phone'       => '+256-700-200-005',
            ...
            [
                ...
                'gender'                  => Gender::MALE,
                'phone_number'            => '+256-700-100-006',
                'email'                   => null,
                'marital_status'          => MaritalStatus::MARRIED,
                'occupation'              => 'Farmer',
                'religion'                => Religion::CHRISTIAN,
                'blood_group'             => BloodGroup::B_NEGATIVE,
                'next_of_kin_name'        => 'Agnes Tumwine',
                'next_of_kin_phone'       => '+256-700-200-006',
                'next_of_kin_relationship'=> KinRelationship::SPOUSE,
                'default_payer_type'      => PayerType::CASH,
                'insured'                 => false,
            ],
            [
                ...
                'gender'                  => Gender::FEMALE,
                'phone_number'            => '+256-700-100-007',
                'email'                   => 'hawa.nantume@example.com',
                'marital_status'          => MaritalStatus::DIVORCED,
                'occupation'              => 'Nurse',
                'religion'                => Religion::MUSLIM,
                'blood_group'             => BloodGroup::A_NEGATIVE,
                'next_of_kin_name'        => 'Ibrahim Nantume',
                'next_of_kin_phone'       => '+256-700-200-007',
                'next_of_kin_relationship'=> KinRelationship::SIBLING,
                'default_payer_type'      => PayerType::INSURANCE,
                'insured'                 => true,
            ],
            [
                ...
                'gender'                  => Gender::MALE,
                'phone_number'            => '+256-700-100-008',
                'email'                   => null,
                'marital_status'          => null,
                'occupation'              => null,
                'religion'                => Religion::CHRISTIAN,
                'blood_group'             => BloodGroup::O_POSITIVE,
                'next_of_kin_name'        => 'Joyce Wanyama',
                'next_of_kin_phone'       => '+256-700-200-008',
                'next_of_kin_relationship'=> KinRelationship::PARENT,
                'default_payer_type'      => PayerType::CASH,
                'insured'                 => false,
            ],
            [
                ...
                'gender'                  => Gender::FEMALE,
                'phone_number'            => '+256-700-100-009',
                'email'                   => null,
                'marital_status'          => MaritalStatus::MARRIED,
                'occupation'              => 'Accountant',
                'religion'                => Religion::CHRISTIAN,
                'blood_group'             => BloodGroup::AB_NEGATIVE,
                'next_of_kin_name'        => 'Peter Atim',
                'next_of_kin_phone'       => '+256-700-200-009',
                'next_of_kin_relationship'=> KinRelationship::SPOUSE,
                'default_payer_type'      => PayerType::INSURANCE,
                'insured'                 => true,
            ],
            [
                ...
                'gender'                  => Gender::MALE,
                'phone_number'            => '+256-700-100-010',
                'email'                   => null,
                'marital_status'          => MaritalStatus::MARRIED,
                'occupation'              => 'Lawyer',
                'religion'                => Religion::OTHER,
                'blood_group'             => BloodGroup::A_POSITIVE,
                'next_of_kin_name'        => 'Margaret Byamugisha',
                'next_of_kin_phone'       => '+256-700-200-010',
                'next_of_kin_relationship'=> KinRelationship::SPOUSE,
                'default_payer_type'      => PayerType::INSURANCE,
                'insured'                 => true,
            ],
        ...
        foreach ($patients as $data) {
            ...
            $patient = Patient::query()->firstOrCreate(
                ...
                [
                    ...
                    'default_payer_type'       => $data['default_payer_type']->value,
                    'tenant_id'                => $tenant->id,
                ],
            );

            // Create insurance record for insured patients
            if ($data['insured'] && $insuranceCompany && $insurancePackage) {
                PatientInsurance::query()->firstOrCreate(
