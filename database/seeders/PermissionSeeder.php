...
final class PermissionSeeder extends Seeder
{
    ...
    private function permissionCatalog(): array
    {
        return [
            ...
            'imaging_orders' => ['view', 'update'],
            'facility_services' => ['view', 'create', 'update', 'delete'],
            'consultation_tariffs' => ['view', 'create', 'update', 'delete'],
            ...
            'billing_deposits' => ['view', 'create', 'apply', 'refund', 'cancel'],
            'billing_write_offs' => ['view', 'create', 'approve', 'reverse'],
    ...
    private function roleDefinitions(): array
    {
        return [
            ...
            'cashier' => [
                ...
                'billing_deposits' => ['view', 'create', 'apply'],
                'billing_write_offs' => ['view', 'create'],
